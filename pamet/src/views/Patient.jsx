...
function Patient({ navigation, route}) {
  ...
  const sortPatients = (criteria) => {
    ...
    switch (criteria) {
      ...
      case "ageAsc":
        sortedPatients.sort(
          (a, b) => new Date(a.bornDate) - new Date(b.bornDate)
        );
        break;
      case "ageDesc":
        sortedPatients.sort(
          (a, b) => new Date(b.bornDate) - new Date(a.bornDate)
        );
        break;
      case "priority":
